...
//3 function
val root3funcRec: (Double, Double) => Double = (x: Double, a: Double) =>
  if (math.abs(math.pow(x, 3) - a) <= math.pow(10, -15) * math.abs(a)) x
  else root3funcRec(x + (a / math.pow(x, 2) - x) / 3, a)

val root3func: Double => Double = (a: Double) => {
  root3funcRec(if (a > 1) a / 3 else a, a)
};


//3 tests

root3(27.0) - 3.0 <= math.pow(10.0, -15.0)
root3(216.0) - 6.0 <= math.pow(10.0, -15.0)
root3(64.0) - 4.0 <= math.pow(10.0, -15.0)
root3func(27.0) - 3.0 <= math.pow(10.0, -15.0)
root3func(216.0) - 6.0 <= math.pow(10.0, -15.0)
root3func(64.0) - 4.0 <= math.pow(10.0, -15.0)
...
initSegment(List("a", "b"), List("a", "b", "c")) == true
